...
<head>
    ...
    <title>Applications | <?php echo $_GET['viewon']; ?></title>
</head>
<body>
    ...
    <div class="app-content">
        ...
        <div class="projects-section-header">
            <p>Applications View: <?php echo $_GET['viewapp']; ?></p>
        </div>
        <div>
        <main>
            <?php 
                $sql = "SELECT * FROM applications_tb
                JOIN assets_tb
                ON applications_tb.asset_id = assets_tb.id
                WHERE user_id='".$_SESSION['id']."' AND application_id = '".$_GET['viewapp']."' LIMIT 1;";
