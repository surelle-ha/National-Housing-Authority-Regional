<?php
    ...
    if(isset($_POST['manualAddAccount'])){
        ...
        if (mysqli_num_rows($result) <= 0) {
            $id = 'NHA'.rand(1000,9999).'N'.rand(10000,99999).'BSK';
        ...
        if($_POST['password'] == $_POST['repassword']){
            ...
            if (mysqli_num_rows($result) <= 0) {
                ...
                if ($conn->query($sql1) === TRUE) {
                    ...
                    <p>'.$__domain.'/login.php?id='.$id.'&conf=JasLLAksAAS1'.RAND(111,999).'0aAPosA@'.$id.'</p>
                    ...
                    header('location: login.php?succ=501');
                } else {
    ...
    if(isset($_GET['conf'])){
        ...
        if ($conn->query($sql1) === TRUE) {
            header('location: login.php?succ=503');
        }
    }
