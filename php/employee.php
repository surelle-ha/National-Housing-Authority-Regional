        ...
        if(isset($_GET['remindpayment'])){ // Remind Payment Function
            ...
            if (mysqli_num_rows($result) > 0) {
                while($row = mysqli_fetch_array($result)) {
                    ...
                    $message = (new Swift_Message('NHA Payment Reminder'))
                    ...
                    <p>A friendly reminder, do not share this link with anyone. We take account security very seriously at NHA.<br>
